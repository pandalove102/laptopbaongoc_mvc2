...
<form method="POST" action="?controller=nhomsanpham&act=add_nhomsanpham"   enctype="multipart/form-data" id="fupdate">
<div class="content">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="form-group label-floating">
                            ...
                            <input type="text" name="id_nhomsanpham" value="" class="form-control">
                        </div>
                        <div class="form-group label-floating">
                            <label class="control-label">Nhóm Sản Phẩm</label>
                            <input type="text" name="ten_nhomsanpham" value="" class="form-control">
                        </div>
                        ...
                        <div class="form-group label-floating">
                            ...
                            <input type="text" name="chiase" value="" class="form-control">
                        </div>
