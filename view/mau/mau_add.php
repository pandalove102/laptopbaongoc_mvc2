...
<form method="POST" action="?controller=mau&act=add_mau"   enctype="multipart/form-data" id="fupdate">
<div class="content">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="form-group label-floating">
                            ...
                            <input type="text" name="id_mau" value="" class="form-control">
                        </div>
                        <div class="form-group label-floating">
                            <label class="control-label">Màu</label>
                            <input type="text" name="ten_mau" value="" class="form-control">
                        </div>
                        <div class="form-group label-floating">
