    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <a href="?controller=mau&act=add_mau_view">
                    <div class="card-header card-header-icon" data-background-color="purple">
                    ...
                    <div class="material-datatables">
                      ...
                      <div class="row">
                          ...
                          <thead>
                              ...
                              <th class="text-center sorting" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 143px;font-family: initial;" aria-label="Position: activate to sort column ascending">Màu</th>
                          ...
                          <?php
                                  foreach($data['danhsachmau'] as $item)
                                  {
                          ?>
                          <tr role="row" class="odd">
                                  <td class="text-center sorting" tabindex="0"><?=$item->id_mau;?></td>
                                  <td class="text-center sorting" tabindex="0"><?=$item->ten_mau;?></td>
                                  ...
                                  <a href="?controller=mau&act=chitiet_mau&id=<?=$item->id_mau;?>" class="btn btn-success btn-simple" >
                                            <i class="material-icons">edit</i>
                                        <div class="ripple-container"></div></a>
                                        <a onclick="return confirm('Bạn có chắc chắn muốn xóa không ?')" href="?controller=mau&act=dell_mau&id=<?=$item->id_mau;?>" class="btn btn-danger btn-simple" >
