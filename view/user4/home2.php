            ...
            <div class="full-width-mega-dropdown">
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-6 col-xs-12">
                        <div class="logo">
                            <a href="index.html">
                                <img src="<?=template_user4_path?>/img/logo/logo.png" alt="main logo">
                            </a>
                        </div>
                    </div>
                    <!-- primary-menu -->
                                ...
                                <li class="mega-parent"><a href="shop.html">Products</a>
                                    <div class="mega-menu-area clearfix">
                                        ...
                                        <div class="mega-menu-photo f-left">
                                            <a href="#">
                                                <img src="<?=template_user4_path?>/img/mega-menu/1.jpg" alt="mega menu image">
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                            ...
                                            <div class="total-cart-pro">
                                                ...
                                                <div class="single-cart clearfix">
                                                    <div class="cart-img f-left">
                                                        <a href="#">
                                                            <img src="<?=template_user4_path?>/img/cart/1.jpg" alt="Cart Product" />
                                                        </a>
                                                        <div class="del-icon">
                                                            <a href="#">
...
<div class="slider-area slider-2">
    <div class="bend niceties preview-2">
        <div id="nivoslider-2" class="slides">   
            <img src="<?=template_user4_path?>/img/slider/slider-2/slider-1.jpg" alt="" title="#slider-direction-1"  />
            <img src="<?=template_user4_path?>/img/slider/slider-2/slider-1.jpg" alt="" title="#slider-direction-2"  />
            <img src="<?=template_user4_path?>/img/slider/slider-2/slider-1.jpg" alt="" title="#slider-direction-3"  />
            <img src="<?=template_user4_path?>/img/slider/slider-2/slider-1.jpg" alt="" title="#slider-direction-4"  />
            <img src="<?=template_user4_path?>/img/slider/slider-2/slider-1.jpg" alt="" title="#slider-direction-5"  />
        </div>
        <!-- ===== direction 1 ===== -->
        <div id="slider-direction-1" class="slider-direction">
            ...
            <div class="slider-content-1-image">
                <div class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                    <div class="layer-1-1">
                        <img src="<?=template_user4_path?>/img/slider/slider-2/layer-1.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="slider-direction-2" class="slider-direction">
            ...
            <div class="wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="layer-1-1 layer-2-1">
                    <img src="<?=template_user4_path?>/img/slider/slider-2/layer-2.png" alt="" />
                </div>
            </div>
        </div>
        <!-- ===== direction 3 ===== -->
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="banner-item banner-2">
                        <div class="banner-img">
                            <a href="#"><img src="<?=template_user4_path?>/img/banner/2.jpg" alt=""></a>
                        </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="banner-item banner-3">
                        <div class="banner-img">
                            <a href="#"><img src="<?=template_user4_path?>/img/banner/3.jpg" alt=""></a>
                        </div>
                ...
                <div class="col-md-4 hidden-sm col-xs-12">
                    <div class="banner-item banner-4">
                        <div class="banner-img">
                            <a href="#"><img src="<?=template_user4_path?>/img/banner/4.jpg" alt=""></a>
                        </div>
                ...
                <div class="row active-featured-product slick-arrow-2">
                        ...
                        <div class="product-item product-item-2">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img src="<?=template_user4_path?>/img/product-2/1.jpg" alt=""/>
                                </a>
                            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="product-item product-item-2">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img src="<?=template_user4_path?>/img/product-2/2.jpg" alt=""/>
                                </a>
                            </div>
                            <div class="product-info">
                                <h6 class="product-title">
                    ...
                    <div class="col-xs-12">
                        <div class="product-item product-item-2">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img src="<?=template_user4_path?>/img/product-2/3.jpg" alt=""/>
                                </a>
                            </div>
                            <div class="product-info">
                                <h6 class="product-title">
                    ...
                    <div class="col-xs-12">
                        <div class="product-item product-item-2">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img src="<?=template_user4_path?>/img/product-2/4.jpg" alt=""/>
                                </a>
                            </div>
                            <div class="product-info">
                                <h6 class="product-title">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    <div class="up-comming-pro gray-bg up-comming-pro-2 clearfix">
                        <div class="up-comming-pro-img f-left">
                            <a href="#">
                                <img src="<?=template_user4_path?>/img/up-comming/2.jpg" alt="">
                            </a>
                        </div>
                ...
                <div class="col-md-4 hidden-sm col-xs-12">
                    <div class="banner-item banner-1">
                        ...
                        <div class="banner-img">
                            <a href="#"><img src="<?=template_user4_path?>/img/banner/1.jpg" alt=""></a>
                        </div>
                        <div class="banner-info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <div class="product-item product-item-2">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="<?=template_user4_path?>/img/product-2/5.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <div class="product-item product-item-2">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="<?=template_user4_path?>/img/product-2/6.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="col-md-3 hidden-sm col-xs-12">
                                <div class="product-item product-item-2">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="<?=template_user4_path?>/img/product-2/7.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="blog-image">
                                        <a href="blog-details.html"><img src="<?=template_user4_path?>/img/blog/4.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="blog-desc">
                    ...
                    <div class="col-xs-12">
                        <div class="blog-item-2">
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="blog-image">
                                        <a href="blog-details.html"><img src="<?=template_user4_path?>/img/blog/5.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="blog-desc">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="footer-logo">
                        <img src="<?=template_user4_path?>/img/logo/logo.png" alt="">
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-3">
                    <ul class="footer-payment">
                        <li>
                            <a href="#"><img src="<?=template_user4_path?>/img/payment/1.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="<?=template_user4_path?>/img/payment/2.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="<?=template_user4_path?>/img/payment/3.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="<?=template_user4_path?>/img/payment/4.jpg" alt=""></a>
                        </li>
                    </ul>
                </div>
            </div>
