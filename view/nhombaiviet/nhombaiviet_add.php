...
<form method="POST" action="?controller=nhombaiviet&act=add_nhombaiviet"   enctype="multipart/form-data" id="fupdate">
<div class="content">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="form-group label-floating">
                            ...
                            <input type="text" name="id_nhombaiviet" value="" class="form-control">
                        </div>
                        <div class="form-group label-floating">
                            <label class="control-label">Tên Bài Viết</label>
                            <input type="text" name="ten_nhombaiviet" value="" class="form-control">
                        </div>
                        <div class="form-group label-floating">
