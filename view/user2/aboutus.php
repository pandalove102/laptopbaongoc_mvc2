        ...
        <div class="section">
            ...
            <div class="about-office">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <img class="rounded img-raised" alt="Raised Image" src="<?=template_user2_path?>/assets/img/bg27.jpg">
                        </div>
                        <div class="col-md-4">
                            <img class="rounded img-raised" alt="Raised Image" src="<?=template_user2_path?>/assets/img/bg24.jpg">
                        </div>
                        <div class="col-md-4">
                            <img class="rounded img-raised" alt="Raised Image" src="<?=template_user2_path?>/assets/img/bg28.jpg">
                        </div>
                        <div class="col-md-6">
                            <img class="rounded img-raised" alt="Raised Image" src="<?=template_user2_path?>/assets/img/project6.jpg">
                        </div>
                        <div class="col-md-6">
                            <img class="rounded img-raised" alt="Raised Image" src="<?=template_user2_path?>/assets/img/project14.jpg">
                        </div>
                    </div>
                </div>
            </div>
