<body class="pricing">
    ...
    <div class="wrapper">
        <div class="page-header page-header-small">
            <div class="page-header-image" data-parallax="true" style="background-image: url('<?=template_user2_path?>/assets/img/bg37.jpg') ;">
            </div>
        ...
        <div class="main">
            ...
            <div class="contactus-1 section-image" style="background-image: url('<?=template_user2_path?>/assets/img/bg27.jpg')">
                <div class="container">
                    <div class="row">
