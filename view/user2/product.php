<body class="product-page">
    ...
    <div class="wrapper">
        <div class="page-header page-header-mini">
            <div class="page-header-image" data-parallax="true" style="background-image: url('data-nav-image="<?=template_user2_path?>/assets/img/pp-cov.jpg') ;">
            </div>
        </div>
        <div class="section">
            <div class="container">
                        ...
                        <div id="productCarousel" class="carousel slide" data-ride="carousel" data-interval="8000">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <img class="d-block img-raised" src="<?=template_user2_path?>/assets/img/pp-1.jpg" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-raised" src="<?=template_user2_path?>/assets/img/pp-2.jpg" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-raised" src="<?=template_user2_path?>/assets/img/pp-3.jpg" alt="Third slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-raised" src="<?=template_user2_path?>/assets/img/pp-4.jpg" alt="Third slide">
                                </div>
                            </div>
                    ...
                    <div class="section-story-overview">
                        <div class="row">
                            <div class="col-md-4 ml-auto mr-auto">
                                <div class="image-container image-left" style="background-image: url('data-nav-image="<?=template_user2_path?>/assets/img/pp-5.jpg')">
                                ...
                                <div class="image-container" style="background-image: url('data-nav-image="<?=template_user2_path?>/assets/img/bg29.jpg')"></div>
                            </div>
                            <div class="col-md-4 ml-auto mr-auto">
                                <!-- First image on the right side, above the article -->
                                <div class="image-container image-right" style="background-image: url('data-nav-image="<?=template_user2_path?>/assets/img/pp-4.jpg')"></div>
                ...
                <div class="features-4">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card card-background card-raised" data-background-color style="background-image: url('data-nav-image="<?=template_user2_path?>/assets/img/bg24.jpg')">
                                    <div class="info">
                            ...
                            <div class="col-md-4">
                                <div class="card card-background card-raised" data-background-color style="background-image: url('data-nav-image="<?=template_user2_path?>/assets/img/bg28.jpg')">
                                    <div class="info">
                                        <div class="icon icon-white">
                            ...
                            <div class="col-md-4">
                                <div class="card card-background card-raised" data-background-color style="background-image: url('data-nav-image="<?=template_user2_path?>/assets/img/bg25.jpg')">
                                    <div class="info">
                                        <div class="icon">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3">
                        <div class="card card-product">
                            <div class="card-image">
                                <a href="#pablo">
                                    <img class="img rounded" src="<?=template_user2_path?>/assets/img/saint-laurent.jpg" />
                                </a>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="card card-product">
                            <div class="card-image">
                                <a href="#pablo">
                                    <img class="img rounded" src="<?=template_user2_path?>/assets/img/gucci.jpg" />
                                </a>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="card card-product">
                            <div class="card-image">
                                <a href="#pablo">
                                    <img class="img rounded" src="<?=template_user2_path?>/assets/img/wooyoungmi.jpg" />
                                </a>
                            </div>
                            <div class="card-body">
                                <h6 class="category text-muted">Popular</h6>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="card card-product">
                            <div class="card-image">
                                <a href="#pablo">
                                    <img class="img rounded" src="<?=template_user2_path?>/assets/img/saint-laurent1.jpg" />
                                </a>
                            </div>
                            <div class="card-body">
