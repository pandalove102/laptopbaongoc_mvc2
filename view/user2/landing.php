<body class="landing-page">
    ...
    <div class="wrapper">
        <div class="page-header page-header-small">
            <div class="page-header-image" data-parallax="true" style="background-image: url('<?=template_user2_path?>/assets/img/bg26.jpg');">
            </div>
                ...
                <div class="section-story-overview">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="image-container image-left" style="background-image: url('<?=template_user2_path?>/assets/img/bg38.jpg')">
                            ...
                            <div class="image-container image-left-bottom" style="background-image: url('<?=template_user2_path?>/assets/img/bg24.jpg')"></div>
                        </div>
                        <div class="col-md-5">
                            <!-- First image on the right side, above the article -->
                            <div class="image-container image-right" style="background-image: url('<?=template_user2_path?>/assets/img/bg39.jpg')"></div>
        ...
        <div class="testimonials-1 section-image" style="background-image: url('<?=template_user2_path?>/assets/img/bg19.jpg')">
            <div class="container">
                <div class="row">
        ...
        <div class="pricing-2">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card card-pricing card-background card-raised" style="background-image: url('<?=template_user2_path?>/assets/img/pricing2.jpg')">
                            <div class="card-body">
