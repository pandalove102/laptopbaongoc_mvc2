<body class="blog-post">
    ...
    <div class="wrapper">
        <div class="page-header page-header-small">
            <div class="page-header-image" data-parallax="true" style="background-image: url('<?=template_user2_path?>/assets/img/bg24.jpg') ;">
            </div>
            ...
            <div class="section section-blog col-md-10 ml-auto mr-auto">
                <div class="container">
                    <div class="section-story-overview">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="image-container image-left" style="background-image: url('<?=template_user2_path?>/assets/img/bg35.jpg')">
                                ...
                                <div class="image-container image-left-bottom" style="background-image: url('<?=template_user2_path?>/assets/img/bg29.jpg')">
                                </div>
                            </div>
                            <div class="col-md-5">
                                <!-- First image on the right side, above the article -->
                                <div class="image-container image-right" style="background-image: url('<?=template_user2_path?>/assets/img/project16.jpg')">
                                </div>
                        ...
                        <div class="col-md-8 ml-auto mr-auto">
                            <div class="media-area">
                                ...
                                <div class="media">
                                    <a class="pull-left" href="#pablo">
                                        <div class="avatar">
                                            <img class="media-object img-raised" src="<?=template_user2_path?>/assets/img/james.jpg" alt="..." />
                                        </div>
                                    </a>
                                ...
                                <div class="media">
                                    <a class="pull-left" href="#pablo">
                                        <div class="avatar">
                                            <img class="media-object img-raised" alt="Tim Picture" src="<?=template_user2_path?>/assets/img/michael.jpg">
                                        </div>
                                    </a>
                                    <div class="media-body">
                                        ...
                                        <div class="media">
                                            <a class="pull-left" href="#pablo">
                                                <div class="avatar">
                                                    <img class="media-object img-raised" alt="64x64" src="<?=template_user2_path?>/assets/img/julie.jpg">
                                                </div>
                                            </a>
                                            <div class="media-body">
                                                <h5 class="media-heading">Tina Andrew
                            ...
                            <div class="media media-post">
                                <a class="pull-left author" href="#pablo">
                                    <div class="avatar">
                                        <img class="media-object img-raised" alt="64x64" src="<?=template_user2_path?>/assets/img/olivia.jpg">
                                    </div>
                                </a>
                                <div class="media-body">
