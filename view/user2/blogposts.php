<body class="blog-posts">
    ...
    <div class="wrapper">
        <div class="page-header page-header-small">
            <div class="page-header-image" data-parallax="true" style="background-image: url('<?=template_user2_path?>/assets/img/bg44.jpg') ;">
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 px-0">
                        <div class="card card-fashion card-background" style="background-image: url('<?=template_user2_path?>/assets/img/project10.jpg')">
                            <div class="card-body">
                    ...
                    <div class="col-md-3 px-0">
                        <div class="card card-fashion card-background" style="background-image: url('<?=template_user2_path?>/assets/img/project11.jpg')">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3 px-0">
                        <div class="card card-fashion card-background" style="background-image: url('<?=template_user2_path?>/assets/img/project12.jpg')">
                        </div>
                    </div>
                    <div class="col-md-3 px-0">
                    ...
                    <div class="col-md-6 px-0">
                        <div class="card card-fashion card-background" style="background-image: url('<?=template_user2_path?>/assets/img/project13.jpg')">
                            <div class="card-body">
                                <div class="card-title text-left">
                                    <h2>
        ...
        <div class="main">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card card-plain card-blog">
                                <div class="card-image">
                                    <a href="#pablo">
                                        <img class="img rounded img-raised" src="<?=template_user2_path?>/assets/img/bg5.jpg" />
                                    </a>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card card-plain card-blog">
                                <div class="card-image">
                                    <a href="#pablo">
                                        <img class="img rounded img-raised" src="<?=template_user2_path?>/assets/img/bg27.jpg" />
                                    </a>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card card-plain card-blog">
                                <div class="card-image">
                                    <a href="#pablo">
                                        <img class="img rounded img-raised" src="<?=template_user2_path?>/assets/img/bg21.jpg" />
                                    </a>
                                </div>
                                <div class="card-body">
            ...
            <div class="section pt-0 pb-0">
                <div class="team-3 section-image" data-parallax="true" style="background-image: url('<?=template_user2_path?>/assets/img/bg26.jpg')">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 ml-auto mr-auto text-center">
