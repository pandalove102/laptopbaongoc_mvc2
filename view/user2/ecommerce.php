<body class="ecommerce-page">
    ...
    <div class="wrapper">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item">
                    <div class="page-header header-filter">
                        <div class="page-header-image" style="background-image: url('<?=template_user2_path?>/assets/img/bg40.jpg');"></div>
                ...
                <div class="carousel-item active">
                    <div class="page-header header-filter">
                        <div class="page-header-image" style="background-image: url('<?=template_user2_path?>/assets/img/bg41.jpg');"></div>
                ...
                <div class="carousel-item">
                    <div class="page-header header-filter">
                        <div class="page-header-image" style="background-image: url('<?=template_user2_path?>/assets/img/bg29.jpg');"></div>
                        <div class="content-center text-center">
                            <div class="row">
        ...
        <div class="main">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="card card-product card-plain">
                                        <div class="card-image">
                                            <a href="#">
                                                <img src="<?=template_user2_path?>/assets/img/polo.jpg" alt="..." />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <a href="#">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card card-product card-plain">
                                        <div class="card-image">
                                            <a href="#">
                                                <img src="<?=template_user2_path?>/assets/img/tom-ford.jpg" alt="..." />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <a href="#">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card card-product card-plain">
                                        <div class="card-image">
                                            <a href="#">
                                                <img src="<?=template_user2_path?>/assets/img/wooyoungmi.jpg" alt="..." />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <a href="#">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card card-product card-plain">
                                        <div class="card-image">
                                            <a href="#">
                                                <img src="<?=template_user2_path?>/assets/img/sweeney.jpg" alt="..." />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <a href="#">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card card-product card-plain">
                                        <div class="card-image">
                                            <a href="#">
                                                <img src="<?=template_user2_path?>/assets/img/kingsman.jpg" alt="..." />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <a href="#">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card card-product card-plain">
                                        <div class="card-image">
                                            <a href="#">
                                                <img src="<?=template_user2_path?>/assets/img/boglioli.jpg" alt="..." />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <a href="#">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 px-0">
                            <div class="card card-fashion card-background" style="background-image: url('<?=template_user2_path?>/assets/img/bg35.jpg')">
                                <div class="card-body">
                        ...
                        <div class="col-md-6 px-0">
                            <div class="card-container">
                                ...
                                <div class="card card-fashion card-background" style="background-image: url('<?=template_user2_path?>/assets/img/bg40.jpg')">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- section -->
            <div class="subscribe-line subscribe-line-image" style="background-image: url('<?=template_user2_path?>/assets/img/bg43.jpg');">
                <div class="container">
                    <div class="row">
