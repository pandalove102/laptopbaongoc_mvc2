                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="tablet-container">
                                <img src="<?=template_user2_path?>/assets/img/ipad2-inverted.png" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="phone-container">
                                <img src="<?=template_user2_path?>/assets/img/iphone2.png" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="info info-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="image-container">
                                <img src="<?=template_user2_path?>/assets/img/ipad3.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-image">
                                    <img src="<?=template_user2_path?>/assets/img/bg28.jpg" class="rounded" alt="">
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-image">
                                    <img src="<?=template_user2_path?>/assets/img/bg26.jpg" class="rounded" alt="">
                                </div>
                                <div class="info text-center">
                                    <div class="icon">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-image">
                                    <img src="<?=template_user2_path?>/assets/img/bg27.jpg" class="rounded" alt="">
                                </div>
                                <div class="info text-center">
                                    <div class="icon">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-image">
                                    <img src="<?=template_user2_path?>/assets/img/bg29.jpg" class="rounded" alt="">
                                </div>
                                <div class="info text-center">
                                    <div class="icon">
                        ...
                        <div class="col-md-10 ml-auto mr-auto">
                            ...
                            <div class="card card-plain card-blog">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="card-image">
                                            <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/examples/card-blog4.jpg" />
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <div class="card card-plain card-blog">
                                ...
                                " src="<?=template_user2_path?>/assets/img/examples/card-blog6.jpg" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-5">
                                    <div class="card card-plain card-blog">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/examples/card-blog7.jpg" />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <h6 class="category text-info">Enterprise</h6>
                                ...
                                <div class="col-md-5">
                                    <div class="card card-plain card-blog">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/examples/card-blog9.jpg" />
                                            </a>
                                        </div>
                                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-5">
                                    <div class="card card-plain card-blog">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/examples/card-blog16.jpg" />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                ...
                                <div class="col-md-5">
                                    <div class="card card-plain card-blog">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/examples/card-blog15.jpg" />
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <h6 class="category text-success">
                        ...
                        <div class="col-md-10 ml-auto mr-auto">
                            ...
                            <div class="card card-plain card-blog">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="card-image">
                                            <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/examples/card-blog10.jpg" />
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <h3 class="card-title">
                            ...
                            <div class="card card-plain card-blog">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/examples/card-blog11.jpg" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                            ...
                            <div class="card card-plain card-blog">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/examples/card-blog12.jpg" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        ...
                                        <div class="author">
                                            <img src="<?=template_user2_path?>/assets/img/michael.jpg" alt="..." class="avatar img-raised">
                    ...
                    <div class="row">
                        <div class="col-md-8 ml-auto mr-auto">
                            ...
                            <div class="card card-plain card-blog">
                                <div class="card-image">
                                    <a href="#pablo">
                                        <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/examples/card-blog13.jpg" />
                                    </a>
                                </div>
                            ...
                            <div class="card card-plain card-blog">
                                <div class="card-image">
                                    <a href="#pablo">
                                        <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/examples/card-blog14.jpg" />
                                    </a>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-blog">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img rounded" src="<?=template_user2_path?>/assets/img/examples/card-blog18.jpg">
                                            </a>
                                        </div>
                                        <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-blog">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img rounded" src="<?=template_user2_path?>/assets/img/examples/card-blog17.jpg">
                                            </a>
                                        </div>
                                        <div class="card-body">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4 mr-1">
                            <div class="card card-profile card-plain">
                                <div class="card-avatar">
                                    <a href="#pablo">
                                        <img class="img img-raised" src="<?=template_user2_path?>/assets/img/michael.jpg" />
                                    </a>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-4 ml-1 mt-4">
                            <div class="card card-profile card-plain">
                                <div class="card-avatar">
                                    <a href="#pablo">
                                        <img class="img img-raised" src="<?=template_user2_path?>/assets/img/emily.jpg" />
                                    </a>
                                </div>
                                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card card-profile card-plain">
                                <div class="card-image">
                                    <a href="#pablo">
                                        <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/examples/card-profile1.jpg" />
                                    </a>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card card-profile card-plain">
                                <div class="card-image">
                                    <a href="#pablo">
                                        <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/examples/card-profile2.jpg" />
                                    </a>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card card-profile card-plain">
                                <div class="card-image">
                                    <a href="#pablo">
                                        <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/examples/card-profile3.jpg" />
                                    </a>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card card-profile">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img" src="<?=template_user2_path?>/assets/img/olivia.jpg" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <div class="card card-profile">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img" src="<?=template_user2_path?>/assets/img/james.jpg" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <div class="card card-profile">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img" src="<?=template_user2_path?>/assets/img/michael.jpg" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <div class="card card-profile">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img" src="<?=template_user2_path?>/assets/img/emily.jpg" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <div class="card card-profile card-plain">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/olivia.jpg" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <div class="card card-profile card-plain">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/emily.jpg" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <div class="card card-profile card-plain">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/james.jpg" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <div class="card card-profile card-plain">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="card-image">
                                            <a href="#pablo">
                                                <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/michael.jpg" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card card-plain">
                                <a href="http://www.creative-tim.com/product/now-ui-kit" target="_blank">
                                    <div class="card-image">
                        ...
                        <div class="col-md-4">
                            <div class="card card-plain">
                                <a href="http://www.creative-tim.com/product/light-bootstrap-dashboard-pro" target="_blank">
                                    <div class="card-image">
                                        <img class="img-raised rounded" src="http://s3.amazonaws.com/creativetim_bucket/products/34/original/opt_lbd_pro_new_thumbnail.jpg?1449352503" />
                                    </div>
                                </a>
                                <div class="card-body">
                                    <a href="http://www.creative-tim.com/product/light-bootstrap-dashboard-pro" target="_blank">
