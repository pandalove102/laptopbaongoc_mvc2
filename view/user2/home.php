<body class="index-page">
    ...
    <nav class="navbar navbar-expand-lg bg-white fixed-top navbar-transparent" color-on-scroll="500">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" data-nav-image="<?=template_user2_path?>/assets/img/blurred-image-1.jpg" data-color="orange">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="<?=template_user2_path?>/index.html" target="_blank">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="<?=template_user2_path?>/sections.html#headers">
                                <i class="now-ui-icons shopping_box"></i> Headers
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/sections.html#features">
                                <i class="now-ui-icons ui-2_settings-90"></i> Features
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/sections.html#blogs">
                                <i class="now-ui-icons text_align-left"></i> Blogs
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/sections.html#teams">
                                <i class="now-ui-icons sport_user-run"></i> Teams
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/sections.html#projects">
                                <i class="now-ui-icons education_paper"></i> Projects
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/sections.html#pricing">
                                <i class="now-ui-icons business_money-coins"></i> Pricing
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/sections.html#testimonials">
                                <i class="now-ui-icons ui-2_chat-round"></i> Testimonials
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/sections.html#contactus">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="<?=template_user2_path?>/examples/about-us.html">
                                <i class="now-ui-icons business_bulb-63"></i> About-us
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/examples/blog-post.html">
                                <i class="now-ui-icons text_align-left"></i> Blog Post
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/examples/blog-posts.html">
                                <i class="now-ui-icons design_bullet-list-67"></i> Blog Posts
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/examples/contact-us.html">
                                <i class="now-ui-icons location_pin"></i> Contact Us
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/examples/landing-page.html">
                                <i class="now-ui-icons education_paper"></i> Landing Page
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/examples/login-page.html">
                                <i class="now-ui-icons users_circle-08"></i> Login Page
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/examples/pricing.html">
                                <i class="now-ui-icons business_money-coins"></i> Pricing
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/examples/ecommerce.html">
                                <i class="now-ui-icons shopping_shop"></i> Ecommerce Page
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/examples/product-page.html">
                                <i class="now-ui-icons shopping_bag-16"></i> Product Page
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/examples/profile-page.html">
                                <i class="now-ui-icons users_single-02"></i> Profile Page
                            </a>
                            <a class="dropdown-item" href="<?=template_user2_path?>/examples/signup-page.html">
        ...
        <div class="page-header clear-filter" filter-color="orange">
            ...
            <h6 class="category category-absolute rellax-text" data-rellax-speed="-2">Designed by
                <a href="http://invisionapp.com/" target="_blank">
                    <img src="<?=template_user2_path?>/assets/img/invision-white-slim.png" class="invision-logo" />
                </a>. Coded by
                <a href="https://www.creative-tim.com" target="_blank">
                    <img src="<?=template_user2_path?>/assets/img/creative-tim-white-slim2.png" class="creative-tim-logo" />
                </a>.</h6>
        </div>
        <div class="main">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="hero-images-container">
                                <img src="<?=template_user2_path?>/assets/img/hero-image-1.png" alt="">
                            </div>
                            <div class="hero-images-container-1">
                                <img src="<?=template_user2_path?>/assets/img/hero-image-2.png" alt="">
                            </div>
                            <div class="hero-images-container-2">
                                <img src="<?=template_user2_path?>/assets/img/hero-image-3.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="gallery-feed">
                                            <img src="<?=template_user2_path?>/assets/img/olivia.jpg" class="img img-raised rounded" alt="" />
                                            <img src="<?=template_user2_path?>/assets/img/james.jpg" class="img img-raised rounded" alt="" />
                                            <img src="<?=template_user2_path?>/assets/img/michael.jpg" class="img img-raised rounded" alt="" />
                                            <img src="<?=template_user2_path?>/assets/img/emily.jpg" class="img img-raised rounded" alt="" />
                                            <img src="<?=template_user2_path?>/assets/img/marie.jpg" class="img img-raised rounded" alt="" />
                                            <img src="<?=template_user2_path?>/assets/img/usher.jpg" class="img img-raised rounded" alt="" />
                                            <img src="<?=template_user2_path?>/assets/img/mike.jpg" class="img img-raised rounded" alt="" />
                                            <img src="<?=template_user2_path?>/assets/img/julie.jpg" class="img img-raised rounded" alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="images">
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                ...
                                <img src="<?=template_user2_path?>/assets/img/julie.jpg" alt="Rounded Image" class="rounded">
                            </div>
                            <div class="col-sm-2">
                                <p class="category">Circle Image</p>
                                <img src="<?=template_user2_path?>/assets/img/julie.jpg" alt="Circle Image" class="rounded-circle">
                            </div>
                            <div class="col-sm-2">
                                <p class="category">Raised</p>
                                <img src="<?=template_user2_path?>/assets/img/julie.jpg" alt="Raised Image" class="rounded img-raised">
                            </div>
                            <div class="col-sm-2">
                                <p class="category">Circle Raised</p>
                                <img src="<?=template_user2_path?>/assets/img/julie.jpg" alt="Thumbnail Image" class="rounded-circle img-raised">
                            </div>
                        </div>
                    </div>
                    <div class="space-70"></div>
                                                ...
                                                <table class="table table-shopping">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="img-container">
                                                                    <img src="<?=template_user2_path?>/assets/img/saint-laurent.jpg" alt="...">
                                                                </div>
                                                            </td>
                                                            <td class="td-name">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="img-container">
                                                                    <img src="<?=template_user2_path?>/assets/img/balmain.jpg" alt="...">
                                                                </div>
                                                            </td>
                                                            <td class="td-name">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="img-container">
                                                                    <img src="<?=template_user2_path?>/assets/img/prada.jpg" alt="...">
                                                                </div>
                                                            </td>
                                                            <td class="td-name">
                            ...
                            <div class="row">
                                <div class="col-md-8 ml-auto mr-auto">
                                    <div class="media-area">
                                        ...
                                        <div class="media">
                                            <a class="pull-left" href="#pablo">
                                                <div class="avatar">
                                                    <img class="media-object img-raised" src="<?=template_user2_path?>/assets/img/marie.jpg" alt="..." />
                                                </div>
                                            </a>
                                        ...
                                        <div class="media">
                                            <a class="pull-left" href="#pablo">
                                                <div class="avatar">
                                                    <img class="media-object img-raised" alt="Tim Picture" src="<?=template_user2_path?>/assets/img/olivia.jpg">
                                                </div>
                                            </a>
                                            <div class="media-body">
                                                ...
                                                <div class="media">
                                                    <a class="pull-left" href="#pablo">
                                                        <div class="avatar">
                                                            <img class="media-object img-raised" alt="64x64" src="<?=template_user2_path?>/assets/img/emily.jpg">
                                                        </div>
                                                    </a>
                                                    <div class="media-body">
                                                        <h5 class="media-heading">Tina Andrew
                                        ...
                                        <div class="media">
                                            <a class="pull-left" href="#pablo">
                                                <div class="avatar">
                                                    <img class="media-object img-raised" alt="64x64" src="<?=template_user2_path?>/assets/img/james.jpg">
                                                </div>
                                            </a>
                                            <div class="media-body">
                                    ...
                                    <div class="media media-post">
                                        <a class="pull-left author" href="#pablo">
                                            <div class="avatar">
                                                <img class="media-object img-raised" alt="64x64" src="<?=template_user2_path?>/assets/img/placeholder.jpg" />
                                            </div>
                                        </a>
                                        <div class="media-body">
                                            <form class="form">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-4">
                                <div class="card" data-background-color="red">
                                    <div class="card-body">
                                        ...
                                        <div class="card-footer">
                                            <div class="author">
                                                <img src="<?=template_user2_path?>/assets/img/julie.jpg" alt="..." class="avatar img-raised">
                                ...
                                <div class="card card-blog">
                                    <div class="card-image">
                                        <img class="img rounded" src="<?=template_user2_path?>/assets/img/project13.jpg">
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="card-footer">
                                            <div class="author">
                                                <img src="<?=template_user2_path?>/assets/img/olivia.jpg" alt="..." class="avatar img-raised">
                                                <span>Lord Alex</span>
                                            </div>
                                            <div class="stats stats-right">
                            ...
                            <div class="col-md-6 col-lg-4">
                                ...
                                <div class="card card-blog">
                                    <div class="card-image">
                                        <a href="#pablo">
                                            <img class="img rounded" src="<?=template_user2_path?>/assets/img/card-blog2.jpg">
                                        </a>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card" data-background-color="blue">
                                    <div class="card-body">
                                        ...
                                        <div class="card-footer">
                                            <div class="author">
                                                <img src="<?=template_user2_path?>/assets/img/james.jpg" alt="..." class="avatar img-raised">
                            ...
                            <div class="col-md-8 offset-md-2 col-lg-4 offset-lg-0">
                                <div class="card card-blog">
                                    <div class="card-image">
                                        <a href="#pablo">
                                            <img class="img rounded" src="<?=template_user2_path?>/assets/img/examples/card-blog6.jpg">
                                        </a>
                                    </div>
                                ...
                                <div class="card card-blog">
                                    <div class="card-image">
                                        <img class="img rounded" src="<?=template_user2_path?>/assets/img/card-blog3.jpg">
                                    </div>
                                    <div class="card-body">
                                        <h6 class="category text-warning">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3">
                                <div class="card card-profile">
                                    <div class="card-image">
                                        <img class="img rounded" src="<?=template_user2_path?>/assets/img/julie.jpg">
                                    </div>
                                    <div class="card-body">
                                        <a href="pablo">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="card card-profile">
                                    <div class="card-avatar">
                                        <a href="#pablo">
                                            <img class="img img-raised" src="<?=template_user2_path?>/assets/img/mike.jpg">
                                        </a>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="card card-profile" data-background-color="black">
                                    <div class="card-avatar">
                                        <a href="#pablo">
                                            <img class="img img-raised" src="<?=template_user2_path?>/assets/img/james.jpg">
                                        </a>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="card card-profile">
                                    <div class="card-body">
                                        <div class="card-avatar">
                                            <a href="#pablo">
                                                <img class="img img-raised" src="<?=template_user2_path?>/assets/img/olivia.jpg">
                                            </a>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4">
                            <div class="card card-blog card-plain">
                                <div class="card-image">
                                    <img class="img rounded img-raised" src="<?=template_user2_path?>/assets/img/project13.jpg">
                                </div>
                                <div class="card-body">
                                    <h6 class="category text-warning">
                                        <i class="now-ui-icons business_bulb-63"></i> Focus
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card card-blog card-plain">
                                <div class="card-image">
                                    <a href="#pablo">
                                        <img class="img rounded img-raised" src="<?=template_user2_path?>/assets/img/card-blog2.jpg">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <h6 class="category text-primary">Features</h6>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card card-blog card-plain">
                                <div class="card-image">
                                    <a href="#pablo">
                                        <img class="img img-raised rounded" src="<?=template_user2_path?>/assets/img/examples/card-blog6.jpg">
                                    </a>
                                </div>
                                <div class="card-body text-center">
                                    <h6 class="category text-danger">
                        ...
                        <div class="col-md-5 col-sm-8">
                            ...
                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                <div class="fileinput-new thumbnail img-raised">
                                    <img src="<?=template_user2_path?>/assets/img/image_placeholder.jpg" alt="...">
                                </div>
                        ...
                        <div class="col-md-3 col-sm-4">
                            ...
                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                <div class="fileinput-new thumbnail img-circle img-raised">
                                    <img src="<?=template_user2_path?>/assets/img/placeholder.jpg" alt="...">
                                </div>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active">
                                        <img class="d-block" src="<?=template_user2_path?>/assets/img/bg1.jpg" alt="First slide">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h5>Nature, United States</h5>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block" src="<?=template_user2_path?>/assets/img/bg3.jpg" alt="Second slide">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h5>Somewhere Beyond, United States</h5>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block" src="<?=template_user2_path?>/assets/img/bg4.jpg" alt="Third slide">
                                        <div class="carousel-caption d-none d-md-block">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
							...
							<img src="<?=template_user2_path?>/assets/img/nucleo.svg" alt="">
						</div> -->
                    ...
                    <div class="modal-body">
                        <div class="instruction">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="picture">
                                        <img src="<?=template_user2_path?>/assets/img/pricing1.jpg" alt="Thumbnail Image" class="rounded img-raised">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="instruction">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="picture">
                                        <img src="<?=template_user2_path?>/assets/img/project9.jpg" alt="Thumbnail Image" class="rounded img-raised">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-header justify-content-center">
                            ...
                            <div class="header header-primary text-center">
                                <div class="logo-container">
                                    <img src="<?=template_user2_path?>/assets/img/now-logo.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="modal-body">
