    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <a href="?controller=nhomquantri&act=add_nhomquantri_view">
                    <div class="card-header card-header-icon" data-background-color="purple">
                        <i class="material-icons">library_books</i>
                    </div></a>
                <div class="card-content">
                    <h4 class="card-title">Nhóm Quản Trị</h4>
                    <div class="toolbar">
                    ...
                    <div class="material-datatables">
                        ...
                        <div class="col-sm-12">
                            ...
                            <th class="text-center sorting" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 143px;font-family: initial;" aria-label="Position: activate to sort column ascending">Nhóm Quản Trị</th>
                            ...
                            <?php
                                foreach($data['dsnhomquantri'] as $item)
                                {
                            ?>       
                            <tr role="row" class="odd">
                                    <td class="text-center sorting" tabindex="0"><?=$item->id_nhomquantri;?></td>
                                    <td class="text-center sorting" tabindex="0"><?=$item->ten_nhomquantri;?></td>
                                    ...
                                    <td class="td-actions text-center">
                                        <!-- <button type="submit" rel="tooltip" value="<?=$item->id_nhomquantri;?>" class="btn btn-info btn-simple" data-original-title="" title="">
                                            <i class="material-icons">person</i>
                                        <div class="ripple-container"></div></button> -->
                                        <a href="?controller=nhomquantri&act=chitiet_nhomquantri&id=<?=$item->id_nhomquantri;?>" class="btn btn-success btn-simple" >
                                            <i class="material-icons">edit</i>
                                        <div class="ripple-container"></div></a>
                                        <a href="?controller=nhomquantri&act=dell_nhomquantri&id=<?=$item->id_nhomquantri;?>" class="btn btn-danger btn-simple" >
