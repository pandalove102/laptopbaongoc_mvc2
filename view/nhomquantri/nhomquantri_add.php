...
<form method="POST" action="?controller=nhomquantri&act=add_nhomquantri"   enctype="multipart/form-data" id="fupdate">
<div class="content">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="form-group label-floating">
                            ...
                            <input type="text" name="id_nhomquantri" value="" class="form-control">
                        </div>
                        <div class="form-group label-floating">
                            <label class="control-label">Nhóm Quản Trị</label>
                            <input type="text" name="ten_nhomquantri" value="" class="form-control">
                        </div>
