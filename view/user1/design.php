<body class="twitter-profile-tweets">
    ...
    <div class="wrapper">
        <div class="page-header page-header-small"  style="background-image: url('<?=template_user1_path?>/assets/img/rihanna_cover.jpg');">
            ...
            <div class="container">
                <div class="row owner">
                    <div class="col-md-2 col-sm-4 col-6 ml-auto mr-auto text-center">
                        <div class="avatar">
                            <img src="<?=template_user1_path?>/assets/img/rihanna.jpg" alt="Circle Image" class="img-circle img-responsive">
                            <div class="following">
                                <btn class="btn btn-sm btn-info btn-just-icon" rel="tooltip" title="Follow"><i class="nc-icon nc-simple-add"></i></btn>
                            </div>
                        </div>
                                    ...
                                    <div class="tweets">
                                        <div class="media">
                                              <a class="pull-left" href="#paper-kit">
                                               <div class="avatar">
                                                    <img class="media-object" src="<?=template_user1_path?>/assets/img/rihanna.jpg" alt="..." />
                                                </div>
                                              </a>
                                        ...
                                        <div class="media">
                                          <a class="pull-left" href="#paper-kit">
                                              <div class="avatar">
                                                 <img class="media-object" alt="Tim Picture" src="<?=template_user1_path?>/assets/img/khaled.jpg">
                                              </div>
                                              <div class="retweet">
                                          ...
                                          <div class="media-body">
                                            ...
                                            <div class="tweet-link">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <img src="<?=template_user1_path?>/assets/img/khaled_tweet.png" alt="Rounded Image" class="img-rounded img-tweet-link img-responsive">
                                                    </div>
                                                    <div class="col-md-8">
                                        ...
                                        <div class="media">
                                          <a class="pull-left" href="#paper-kit">
                                              <div class="avatar">
                                                 <img class="media-object" alt="Tim Picture" src="<?=template_user1_path?>/assets/img/rihanna.jpg">
                                              </div>
                                          </a>
                                          <div class="media-body">
                                            <strong>Rihanna</strong>
                                            <h5 class="media-heading"><small>@rihanna &middot;  8 Jan 2016</small></h5>
                                             ...
                                             <img src="<?=template_user1_path?>/assets/img/rihanna_tweet.jpeg" alt="Rounded Image" class="img-rounded img-tweet">
                                        ...
                                        <div class="media last-media">
                                          <a class="pull-left" href="#paper-kit">
                                              <div class="avatar">
                                                 <img class="media-object" alt="Tim Picture" src="<?=template_user1_path?>/assets/img/billboard.jpeg">
                                              </div>
                                              <div class="retweet">
                                                    <btn class="btn btn-xs btn-success btn-just-icon btn-sm" rel="tooltip" title="Follow"><i class="fa fa-retweet"></i></btn>
                                              </div>
                                                ...
                                                <ul class="list-unstyled">
                                                    <li class="account">
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="avatar">
                                                                    <img src="<?=template_user1_path?>/assets/img/chet_faker_1.jpg" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-7 description-section">
                                                                Chet Faker <a href="#paper-kit" class="text-muted">@chetfaker</a></span>
                                                                <br />
                                                    ...
                                                    <li class="account">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-7 description-section">
                                                                John Green <a href="#paper-kit" class="text-muted">@johngreen</a></span>
                                                                <br />
                                                    ...
                                                    <li class="account">
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="avatar">
                                                                    <img src="<?=template_user1_path?>/assets/img/drake.jpg" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-7 description-section">
                                                                Drake <a href="#paper-kit" class="text-muted">@drake</a></span>
                                                                <br />
