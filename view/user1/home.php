<div class="wrapper">
        <div class="page-header" style="background-image: url('<?=template_user1_path?>/assets/img/cover.jpg')">
            ...
            <div class="section section-buttons section-gray">
                <div class="container">
                    ...
                    <div id="switches">
                        ...
                        <label>
                            <input type="checkbox" data-toggle="switch" checked="" data-on-color="default" data-off-color="default"><span class="toggle"></span>
                        </label>
                        <label>
                            <input type="checkbox" data-toggle="switch"  data-off-color="default" data-on-color="default"><span class="toggle"></span>
                        </label>&nbsp;&nbsp;&nbsp;
                        <label>
                            <input type="checkbox" data-toggle="switch" checked="" data-on-color="primary" data-off-color="primary"><span class="toggle"></span>
                        </label>
                        <label>
                            <input type="checkbox" data-toggle="switch" data-off-color="primary" data-on-color="primary"><span class="toggle"></span>
                        </label>&nbsp;&nbsp;&nbsp;
                        <label>
                            <input type="checkbox" data-toggle="switch" checked="" data-on-color="info" data-off-color="info"><span class="toggle"></span>
                        </label>
                        <label>
                            <input type="checkbox" data-toggle="switch" data-off-color="info" data-on-color="info"><span class="toggle"></span>
                        </label>
                        ...
                        <label>
                            <input type="checkbox" data-toggle="switch" checked="" data-on-text="<i class='nc-icon nc-check-2'></i>" data-off-text="<i class='nc-icon nc-simple-remove'></i>" data-on-color="success" data-off-color="success"><span class="toggle"></span>
                        </label>
                        <label>
                            <input type="checkbox" data-toggle="switch"  data-on-text="<i class='nc-icon nc-check-2'></i>" data-off-text="<i class='nc-icon nc-simple-remove'></i>" data-on-color="success" data-off-color="success"><span class="toggle"></span>
                        </label>&nbsp;&nbsp;&nbsp;
                        <label>
                            <input type="checkbox" data-toggle="switch" checked="" data-on-text="<i class='nc-icon nc-check-2'></i>" data-off-text="<i class='nc-icon nc-simple-remove'></i>" data-on-color="warning" data-off-color="warning"><span class="toggle"></span>
                        </label>
                        <label>
                            <input type="checkbox" data-toggle="switch"  data-on-text="<i class='nc-icon nc-check-2'></i>" data-off-text="<i class='nc-icon nc-simple-remove'></i>" data-on-color="warning" data-off-color="warning"><span class="toggle"></span>
                        </label>&nbsp;&nbsp;&nbsp;
                        <label>
                            <input type="checkbox" data-toggle="switch" checked="" data-on-text="<i class='nc-icon nc-check-2'></i>" data-off-text="<i class='nc-icon nc-simple-remove'></i>" data-on-color="danger" data-off-color="danger"><span class="toggle"></span>
                        </label>
                        <label>
                            <input type="checkbox" data-toggle="switch"  data-on-text="<i class='nc-icon nc-check-2'></i>" data-off-text="<i class='nc-icon nc-simple-remove'></i>" data-on-color="danger" data-off-color="danger"><span class="toggle"></span>
                        </label>
                    </div>
                    <div id="labels">
                        <div class="title">
                        ...
                        <div class="row">
                           <div class="col-md-2 col-sm-3">
                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group">
                                    <select name="huge" class="selectpicker" data-style="btn-link btn-success btn-round" data-menu-style="dropdown-success">
                                        <option disabled selected> Choose city</option>
                                        <option value="1">Paris </option>
                                        <option value="1">Bucharest</option>
                                        <option value="1">Rome</option>
                            ...
                            <div class="col-md-3 col-sm-3 ">
                                <div class="form-group">
                                    <select name="huge" class="selectpicker" data-style="btn-danger btn-round"  data-menu-style="dropdown-danger">
                                        <option disabled selected> Choose city</option>
                                        <option value="1">Paris </option>
                                        <option value="1">Bucharest</option>
                                        <option value="1">Rome</option>
                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group">
                                    <select name="huge" class="selectpicker" data-style="btn-info btn-round" data-menu-style="dropdown-info">
                                        <option disabled selected> Choose city</option>
                                        <option value="1">Paris </option>
                                        <option value="1">Bucharest</option>
                                        <option value="1">Rome</option>
                                        ...
                                        <li class="nav-item dropdown">
                                            <a href="#paper-kit" class="nav-link" data-toggle="dropdown" width="30" height="30">
                                                <div class="profile-photo-small">
                                                    <img src="<?=template_user1_path?>//assets/img/faces/joe-gardner-2.jpg" alt="Circle Image" class="img-circle img-responsive img-no-padding">
                                                </div>
                                            </a>
                                              <ul class="dropdown-menu dropdown-menu-right dropdown-info">
                                    ...
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a href="#paper-kit" class="nav-link navbar-brand" data-toggle="dropdown" width="30" height="30">
                                                <div class="profile-photo-small">
                                                    <img src="<?=template_user1_path?>//assets/img/faces/erik-lucatero-2.jpg" alt="Circle Image" class="img-circle img-responsive img-no-padding">
                                                </div>
                                            </a>
                                            <ul class="dropdown-menu dropdown-menu-right dropdown-danger">
                                                <div class="dropdown-header">Dropdown header</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 offset-md-2 col-sm-8">
                        <div class="links">
                            ...
                            <div class="copyright">
                                <div class="pull-left">
                                    © <script>document.write(new Date().getFullYear())</script>, made with <i class="fa fa-heart heart"></i> in Bucharest
                                </div>
...
<!--             info areas -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-3">
                            ...
                            <img src="<?=template_user1_path?>//assets/img/sections/por7o.jpg" class="img-rounded img-responsive" alt="Rounded Image">
                            <div class="img-details">
                                <div class="author">
                                    <img src="<?=template_user1_path?>//assets/img/faces/joe-gardner-2.jpg" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                                </div>
                                <p>Sonia Green </p>
                            </div>
                        </div>
                        <div class="col-sm-3 col-md-2 mr-auto ml-auto">
                            ...
                            <img src="<?=template_user1_path?>//assets/img/faces/kaci-baum-2.jpg" class="img-circle img-no-padding img-responsive" alt="Rounded Image">
                            <p class="text-center">Brigitte Bardot</p>
                        </div>
                        <div class="col-sm-3 col-md-2 mr-auto">
                            <h4 class="images-title">Thumbnail</h4>
                            <img src="<?=template_user1_path?>//assets/img/faces/erik-lucatero-2.jpg" class="img-thumbnail img-responsive" alt="Rounded Image">
                    ...
                    <table class="table table-shopping">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="img-container">
                                        <img src="<?=template_user1_path?>//assets/img/tables/agenda.png" alt="Agenda">
                                    </div>
                                </td>
                                <td class="td-product">
                            ...
                            <tr>
                                 <td>
                                    <div class="img-container">
                                        <img src="<?=template_user1_path?>//assets/img/tables/stylus.jpg" alt="Stylus"/>
                                    </div>
                                </td>
                                <td class="td-product">
                            ...
                            <tr>
                                <td>
                                    <div class="img-container">
                                        <img src="<?=template_user1_path?>//assets/img/tables/evernote.png" alt="Evernote">
                                    </div>
                                </td>
                                <td class="td-product">
    ...
    <div class="section section-nude-gray">
        <div class="container tim-container">
            ...
            <div class="section section-blue" class="javascript-components">
                <div class="container">
                    <div class="title">
                                        ...
                                        <div class="modal-body">
                                            <div class="instruction">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="picture">
                                                            <img src="<?=template_user1_path?>//assets/img/sections/angelo-pantazis.jpg" alt="Thumbnail Image"  class="img-rounded img-responsive">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="instruction">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="picture">
                                                            <img src="<?=template_user1_path?>//assets/img/sections/rawpixel-coms.jpg" alt="Thumbnail Image"  class="img-rounded img-responsive">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
                <div class="row">
                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-md-3 col-sm-4 gallery-item">
                        <a href="<?=template_user1_path?>/assets/img/gallery/outfit-gucci.jpg" itemprop="contentUrl" data-size="750x1002">
                            <img src="<?=template_user1_path?>//assets/img/gallery/outfit-gucci.jpg" itemprop="thumbnail" alt="Image description" class="vertical-image img-rounded img-responsive" />
                        </a>
                        <figcaption itemprop="caption description" class="gallery-caption">Gucci</figcaption>
                    </figure>

                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-md-3 col-sm-4 gallery-item">
                        <a href="<?=template_user1_path?>/assets/img/gallery/outfit-paul-smith.jpg" itemprop="contentUrl" data-size="750x1002">
                            <img src="<?=template_user1_path?>//assets/img/gallery/outfit-paul-smith.jpg" itemprop="thumbnail" alt="Image description" class="vertical-image img-rounded img-responsive" />
                        </a>
                        <figcaption itemprop="caption description" class="gallery-caption">Paul Smith</figcaption>
                    </figure>

                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-md-3 col-sm-4 gallery-item">
                        <a href="<?=template_user1_path?>/assets/img/gallery/outfit-maison-margiela.jpg" itemprop="contentUrl" data-size="750x1002">
                            <img src="<?=template_user1_path?>//assets/img/gallery/outfit-maison-margiela.jpg" itemprop="thumbnail" alt="Image description" class="vertical-image img-rounded img-responsive" />
                        </a>
                        <figcaption itemprop="caption description" class="gallery-caption">Maison Margiela</figcaption>
                    </figure>
                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-md-3 col-sm-4 gallery-item">
                        <a href="<?=template_user1_path?>/assets/img/gallery/outfit-burberry.jpg" itemprop="contentUrl" data-size="750x1002">
                            <img src="<?=template_user1_path?>//assets/img/gallery/outfit-burberry.jpg" itemprop="thumbnail" alt="Image description" class="vertical-image img-rounded img-responsive" />
                        </a>
                ...
                <div class="row">
                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-md-3 col-sm-4 gallery-item">
                        <a href="<?=template_user1_path?>/assets/img/gallery/ressence.jpg" itemprop="contentUrl" data-size="960x800">
                            <img src="<?=template_user1_path?>//assets/img/gallery/ressence.jpg" itemprop="thumbnail" alt="Image description" class="horizontal-image img-rounded img-responsive" />
                        </a>
                    </figure>
                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-md-3 col-sm-4 gallery-item">
                        <a href="<?=template_user1_path?>/assets/img/gallery/gucci-sun.jpg" itemprop="contentUrl" data-size="960x800">
                            <img src="<?=template_user1_path?>//assets/img/gallery/gucci-sun.jpg" itemprop="thumbnail" alt="Image description" class="small-horizontal-image img-rounded img-responsive" />
                        </a>
                    </figure>
                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-md-3 col-sm-4 gallery-item">
                        <a href="<?=template_user1_path?>/assets/img/gallery/bottega.jpg" itemprop="contentUrl" data-size="960x800">
                            <img src="<?=template_user1_path?>//assets/img/gallery/bottega.jpg" itemprop="thumbnail" alt="Image description" class="small-horizontal-image img-rounded img-responsive" />
                        </a>
                    </figure>
                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-md-3 col-sm-4 gallery-item">
                        <a href="<?=template_user1_path?>/assets/img/gallery/bracelet.jpg" itemprop="contentUrl" data-size="960x800">
                            <img src="<?=template_user1_path?>//assets/img/gallery/bracelet.jpg" itemprop="thumbnail" alt="Image description" class="small-horizontal-image img-rounded img-responsive" />
                        </a>
                    </figure>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <button type="button" class="btn btn-warning btn-round" data-toggle="tooltip" data-placement="left" title="Tooltip on left">On left</button>
                <button type="button" class="btn btn-warning btn-round" data-toggle="tooltip" data-placement="right" title="Tooltip on right">On right</button>
                <button type="button" class="btn btn-warning btn-round" data-toggle="tooltip" data-placement="top" title="Tooltip on top">On top</button>
                <button type="button" class="btn btn-warning btn-round" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom">On bottom</button>
            </div>
            <div class="col-md-12">
                <div class="title">
                    <h3>Popovers</h3>
                ...
                <div class="col-md-3 col-sm-4">
                    ...
                    <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                        <div class="fileinput-new thumbnail img-circle img-no-padding" style="width: 150px; height: 150px;">
                            <img src="<?=template_user1_path?>//assets/img/placeholder.jpg" alt="...">
                        </div>
    ...
    <div class="section section-gray" id="cards">
            <div class="container tim-container">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="card card-blog">
                            <div class="card-image">
                                <a href="#pablo">
                                    <img class="img" src="<?=template_user1_path?>//assets/img/sections/neill-kumar.jpg">
                                </a>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="card card-blog">
                            <div class="card-image">
                                <a href="#pablo">
                                    <img class="img" src="<?=template_user1_path?>//assets/img/sections/anders-jilden.jpg">
                                </a>
                            </div>
                            <div class="card-body">
                                <h4 class="card-title">
                        ...
                        <div class="card" data-background="image" style="background-image: url('<?=template_user1_path?>/assets/img/sections/rawpixel-com.jpg')">
                            <div class="card-body">
                                <a href="#pablo">
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <div class="author">
                                    <a href="#pablo">
                                       <img src="<?=template_user1_path?>//assets/img/faces/kaci-baum-2.jpg" alt="..." class="avatar-big img-raised border-gray">
                                    </a>
                        ...
                        <div class="card">
                            <div class="card-image">
                                <a href="#pablo">
                                    <img class="img" src="<?=template_user1_path?>//assets/img/sections/david-marcu.jpg">
                                </a>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <div class="author">
                                        <a href="#pablo">
                                           <img src="<?=template_user1_path?>//assets/img/rihanna.jpg" alt="..." class="avatar img-raised">
                                           <span>Lord Alex</span>
                                        </a>
                                    </div>
                                   <div class="stats">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="card card-pricing" data-background="image" style="background-image: url('<?=template_user1_path?>/assets/img/sections/mika-matin.jpg')">
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card" data-background="image" style="background-image: url('<?=template_user1_path?>/assets/img/sections/uriel-soberanes.jpg')">
                            <div class="card-body">
                                <h6 class="card-category">
                    ...
                    <div class="col-md-4">
                        <div class="card" data-background="image" style="background-image: url('<?=template_user1_path?>/assets/img/sections/david-marcu.jpg')">
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card" data-background="image" style="background-image: url('<?=template_user1_path?>/assets/img/sections/leonard-cotte.jpg')">
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="card card-profile">
                            <div class="card-cover" style="background-image: url('<?=template_user1_path?>/assets/img/sections/angelo-pantazis.jpg')">
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card card-profile">
                            <div class="card-cover" style="background-image: url('<?=template_user1_path?>/assets/img/sections/pavel-kosov.jpg')">
                            </div>
                            <div class="card-avatar border-white">
                                <a href="#avatar">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card card-profile">
                            <div class="card-avatar border-white">
                                <a href="#avatar">
                                    <img src="<?=template_user1_path?>//assets/img/faces/kaci-baum-2.jpg" alt="..."/>
                                </a>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card card-profile">
                            <div class="card-avatar border-white">
                                <a href="#avatar">
                                    <img src="<?=template_user1_path?>//assets/img/faces/erik-lucatero-2.jpg" alt="..."/>
                                </a>
                            </div>
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="card card-plain">
                            ...
                            <div class="card-image">
                                <a href="#paper-kit">
                                    <img src="<?=template_user1_path?>//assets/img/sections/ilya-yakover.jpg" alt="Rounded Image" class="img-rounded img-responsive">
                                </a>
                                <div class="card-body">
                                    <a href="#paper-kit">
                                        <div class="author">
                                            <img src="<?=template_user1_path?>//assets/img/faces/clem-onojeghuo-3.jpg" alt="Circle Image" class="img-circle img-no-padding img-responsive img-raised">
                                        </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="card-image text-center">
                            <a href="#paper-kit">
                                <img src="<?=template_user1_path?>//assets/img/sections/rawpixel-coms.jpg" alt="Rounded Image" class="img-rounded img-responsive">
                            </a>
                    ...
                    <div class="col-md-3">
                        <div class="card-image text-center">
                            <a href="#paper-kit">
                                <img src="<?=template_user1_path?>//assets/img/sections/joshua-stannard.jpg" alt="Rounded Image" class="img-rounded img-responsive">
                            </a>
                            <div class="card-body details-center">
                                <a href="#paper-kit">
                                    <div class="author">
