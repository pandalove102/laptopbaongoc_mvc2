...
<div class="wrapper">
	<div class="page-header section-dark" style="background-image: url('<?=template_user1_path?>assets/img/sections/pk-pro-cover.jpg')">
		<div class="content-center">
			<div class="container">
				<div class="title-brand">
					...
					<div class="fog-low">
						<img src="<?=template_user1_path?>/assets/img/sections/fog-low.png" alt="">
					</div>
		...
		<h6 class="category category-absolute">Designed and coded by
			<a href="https://www.creative-tim.com" target="_blank">
				<img src="<?=template_user1_path?>/assets/img/creative-tim-white-slim2.png" class="creative-tim-logo">
			</a>
		</h6>
	</div>
		...
		<div class="row">
			<div class="col-md-12 col-lg-6">
				<div class="image-container">
					<img class="components-macbook" src="<?=template_user1_path?>/assets/img/presentation-page/laptop-basic.png" alt="" />
					<img class="table-img" src="<?=template_user1_path?>/assets/img/presentation-page/table.jpg" alt="" />
					<img class="share-btn-img" src="<?=template_user1_path?>/assets/img/presentation-page/share-btn.png" alt="" />
					<img class="coloured-card-btn-img" src="<?=template_user1_path?>/assets/img/presentation-page/coloured-card-with-btn.png" alt="" />
					<img class="coloured-card-img" src="<?=template_user1_path?>/assets/img/presentation-page/coloured-card.png" alt="" />
					<img class="social-img" src="<?=template_user1_path?>/assets/img/presentation-page/social-row.png" alt="" />
					<img class="pin-btn-img" src="<?=template_user1_path?>/assets/img/presentation-page/pin-btn.png" alt="" />
				</div>
			</div>
				...
				<ul class="grid">
					<li class="grid__item first-card">
						<a class="grid__link" href="index.html#cards">
							<img class="grid__img layer" src="<?=template_user1_path?>/assets/img/presentation-page/try/purple-card.png" alt="01" />
						</a>
					</li>
					<li class="grid__item second-card">
						<a class="grid__link" href="index.html#cards">
							<img class="grid__img layer" src="<?=template_user1_path?>/assets/img/presentation-page/try/twitter-card.jpg" alt="02" />
						</a>
					</li>
					<li class="grid__item third-card">
						<a class="grid__link" href="index.html#cards">
							<img class="grid__img layer" src="<?=template_user1_path?>/assets/img/presentation-page/try/facebook-card.jpg" alt="03" />
						</a>
					</li>
					<li class="grid__item fourth-card">
						<a class="grid__link" href="index.html#cards">
							<img class="grid__img layer" src="<?=template_user1_path?>/assets/img/presentation-page/try/pricing-card.jpg" alt="04" />
						</a>
					</li>
					<li class="grid__item fifth-card">
						<a class="grid__link" href="index.html#cards">
							<img class="grid__img layer" src="<?=template_user1_path?>/assets/img/presentation-page/try/blog-card.jpg" alt="05" />
						</a>
					</li>
					<li class="grid__item sixth-card">
						<a class="grid__link" href="index.html#cards">
							<img class="grid__img layer" src="<?=template_user1_path?>/assets/img/presentation-page/try/capture.jpg" alt="06" />
						</a>
					</li>
					<li class="grid__item seventh-card">
						<a class="grid__link" href="index.html#cards">
							<img class="grid__img layer" src="<?=template_user1_path?>/assets/img/presentation-page/try/team-card.jpg" alt="07" />
						</a>
					</li>
					<li class="grid__item eight-card">
						<a class="grid__link" href="index.html#cards">
							<img class="grid__img layer" src="<?=template_user1_path?>/assets/img/presentation-page/try/testimonal-card.jpg" alt="07" />
						</a>
					</li>
					<li class="grid__item ninth-card">
						<a class="grid__link" href="index.html#cards">
							<img class="grid__img layer" src="<?=template_user1_path?>/assets/img/presentation-page/try/pricing-card-icon.jpg" alt="07" />
						</a>
					</li>
				</ul>
			</div>
		...
		<div class="section section-content section-gray">
			<div class="container">
				<div class="row">
					<div class="col-md-7">
						<div class="image-container">
							<img class="img" src="<?=template_user1_path?>/assets/img/presentation-page/ipad-content-2.png"/>
							<img class="area-img add-animation" src="<?=template_user1_path?>/assets/img/presentation-page/ipad-left-img.jpg"/>
							<img class="info-img add-animation" src="<?=template_user1_path?>/assets/img/presentation-page/ipad-right-img.jpg"/>
						</div>
					</div>
		...
		<div class="container-fluid">
			<div class="section-cols">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/header-1.jpg" alt="" />
						</div>
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/header-2.jpg" alt="" />
						</div>
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/header-3.jpg" alt="" />
						</div>
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/header-4.jpg" alt="" />
						</div>
					</div>

					<div class="row">
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/team-cards-social.jpg" alt="" />
						</div>
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/bg-pricing-card.jpg" alt="" />
						</div>
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/white-pricing-card.jpg" alt="" />
						</div>
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/team-member-card.jpg" alt="" />
						</div>
					</div>

					<div class="row">
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/testimonials-1.jpg" alt="" />
						</div>
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/blog-bg-cards.jpg" alt="" />
						</div>
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/our-products.jpg" alt="" />
						</div>
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/projects-cards.jpg" alt="" />
						</div>
					</div>

					<div class="row">
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/blogpost-cards.jpg" alt="" />
						</div>
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/blogpost-2-cards.jpg" alt="" />
						</div>
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/coloured-picind-card.jpg" alt="" />
						</div>
						<div class="col-md-3">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/screenshots/team-3.jpg" alt="" />
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					...
					<div class="card card-image card-hover-effect">
						<a target="_blank" href="examples/twitter-redesign.html">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/examples/twitter.png">
						</a>
					</div>
					...
					<div class="card card-image">
						<a target="_blank" href="examples/422.html">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/examples/422.png">
					</div>
					...
					<div class="card card-image">
						<a target="_blank" href="examples/discover.html">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/examples/discover.png">
						</a>
					</div>
					...
					<div class="card card-image">
						<a target="_blank" href="examples/login.html">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/examples/login-page.png">
						</a>
					</div>
					...
					<div class="card card-image">
						<a target="_blank" href="examples/blog-post.html">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/examples/blog-post.png">
					</div>
					...
					<div class="card card-image">
						<a target="_blank" href="examples/settings.html">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/examples/settings.png">
						</a>
					</div>
				</div>
				...
				<div class="col-md-4">
					...
					<div class="card card-image">
						<a target="_blank" href="examples/register.html">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/examples/register.png">
						</a>
					</div>
					...
					<div class="card card-image">
						<a target="_blank" href="examples/profile.html">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/examples/profile.png">
					</div>
					<div class="details-text">
						Product Page
					</div>
					<div class="card card-image">
						<a target="_blank" href="examples/product-page.html">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/examples/product.png">
						</a>
					</div>
					...
					<div class="card card-image">
						<a target="_blank" href="examples/contact-us.html">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/examples/contact-us.png">
						</a>
					</div>
					...
					<div class="card card-image">
						<a target="_blank" href="examples/search-with-sidebar.html">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/examples/search.png">
						</a>
					</div>
					...
					<div class="card card-image">
						<a target="_blank" href="examples/404.html">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/examples/404.png">
						</a>
					</div>
					...
					<div class="card card-image">
						<a target="_blank" href="examples/add-product.html">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/examples/add-product.png">
						</a>
					</div>
					...
					<div class="card card-image card-hover-effect">
						<a target="_blank" href="examples/about-us.html">
							<img src="<?=template_user1_path?>/assets/img/presentation-page/examples/about-us.png">
						</a>
					</div>
				...
				<div class="col-md-4">
					...
					<div class="card card-image">
						<a target="_blank" href="examples/blog-posts.html">
					...
					<div class="card card-image">
						<a target="_blank" href="examples/500.html">
					...
					<div class="card card-image">
						<a target="_blank" href="examples/ecommerce.html">
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-6 text-center">
					...
					<br/>
	                <a href="nucleo-icons-demo.html" class="btn btn-primary btn-round btn-lg " target="_blank">View Demo Icons</a>
						...
						<div class="col-md-6">
							<div class="card card-pricing">
								<div class="card-body">
									...
									<div class="card-footer">
										<a href="https://www.creative-tim.com/product/paper-kit-2-pro" class="btn btn-danger btn-round">Buy Now</a>
									</div>
								</div>
							</div>
						</div>
