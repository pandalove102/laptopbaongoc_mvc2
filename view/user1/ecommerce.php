               ...
               <div class="row">
                    <div class="col-md-4">
						<div class="card card-product card-plain">
							<div class="card-image">
								<a href="#paper-kit">
									<img src="<?=template_user1_path?>/assets/img/ecommerce/balmain_5.jpg" alt="Rounded Image" class="img-rounded img-responsive">
								</a>
								<div class="card-body">
									...
									<div class="price">
										<strike>3.520 &euro;</strike> <span class="text-danger">2.900 &euro;</span>
									</div>
								</div>
							</div>
						</div>
                    ...
                    <div class="col-md-4">
						<div class="card card-product card-plain">
							<div class="card-image">
								<a href="#paper-kit">
									<img src="<?=template_user1_path?>/assets/img/ecommerce/balmain_3.jpg" alt="Rounded Image" class="img-rounded img-responsive">
								</a>
								<div class="card-body">
									<div class="card-description">
									...
									<div class="price">
										<strike>2.675 &euro;</strike> <span class="text-danger">2.000 &euro;</span>
									</div>
								</div>
							</div>
						</div>
                    ...
                    <div class="col-md-4">
						<div class="card card-product card-plain">
							<div class="card-image">
								<a href="#paper-kit">
									<img src="<?=template_user1_path?>/assets/img/ecommerce/balmain_4.jpg" alt="Rounded Image" class="img-rounded img-responsive">
								</a>
								<div class="card-body">
									<div class="card-description">
									...
									<div class="price">
										<strike>3.915 &euro;</strike> <span class="text-danger">3.125 &euro;</span>
									</div>
								</div>
							</div>
						</div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
									<div class="card card-product card-plain">
										<div class="card-image">
											<a href="#paper-kit">
												<img src="<?=template_user1_path?>/assets/img/ecommerce/balmain_1.jpg" alt="Rounded Image" class="img-rounded img-responsive">
											</a>
											<div class="card-body">
												<div class="card-description">
                                ...
                                <div class="col-md-4 col-sm-4">
									<div class="card card-product card-plain">
										<div class="card-image">
											<a href="#paper-kit">
												<img src="<?=template_user1_path?>/assets/img/ecommerce/balmain_2.jpg" alt="Rounded Image" class="img-rounded img-responsive">
											</a>
											<div class="card-body">
												<div class="card-description">
                                ...
                                <div class="col-md-4 col-sm-4">
									<div class="card card-product card-plain">
										<div class="card-image">
											<a href="#paper-kit">
												<img src="<?=template_user1_path?>/assets/img/ecommerce/balmain_8.jpg" alt="Rounded Image" class="img-rounded img-responsive">
											</a>
											<div class="card-body">
												<div class="card-description">
