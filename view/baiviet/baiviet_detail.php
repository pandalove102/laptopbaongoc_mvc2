...
<form method="POST" action="?controller=baiviet&act=update_baiviet&id=11<?=@$data['chitiet_baiviet']->id_baiviet?>"   enctype="multipart/form-data" id="fupdate">
<div class="content">
                        ...
                        <div class="form-group label-floating">
                                ...
                                <select  class="selectpicker" name="id_nhombaiviet"  data-style="btn btn-primary btn-round" style="border-radius: 4px" title="Single Select" data-size="7" tabindex="-98">
                                        ...
                                        <?php
                                            ...
                                            {
                                        ?>
                                        <option   value="<?php echo @$v->id_nhombaiviet ?>" <?php if(@$v->id_nhombaiviet==$data['chitiet_baiviet']->id_nhombaiviet) echo "selected" ?>>
