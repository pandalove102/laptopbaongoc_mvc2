                    ...
                    <div class="row">
                        <div class="active-slider-1 slick-arrow-1 slick-dots-1">
                            ...
                            <div class="col-md-12">
                                <div class="layer-1">
                                    <div class="slider-img">
                                        <img src="<?=template_user4_path?>/img/slider/slider-1/1.jpg" alt="">
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="layer-1">
                                    <div class="slider-img">
                                        <img src="<?=template_user4_path?>/img/slider/slider-1/2.jpg" alt="">
                                    </div>
                                    <div class="slider-info gray-bg">
                                        <div class="slider-info-inner">
                                            <h1 class="slider-title-1 text-uppercase text-black-1">WaterProof smartphone</h1>
                            ...
                            <div class="modal-product clearfix">
                                <div class="product-images">
                                    <div class="main-image images">
                                        <img alt="" src="<?=template_user4_path?>/img/product/quickview.jpg">
                                    </div>
                                </div><!-- .product-images -->
