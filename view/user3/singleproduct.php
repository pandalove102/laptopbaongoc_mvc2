							...
							<div class="single-product-tab-content">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane active" id="img-one">
										<img src="<?=template_user3_path?>/img/single-product/mediam/3.jpg" alt="" />
									...
									<div role="tabpanel" class="tab-pane" id="img-two">
										<img src="<?=template_user3_path?>/img/single-product/mediam/2.jpg" alt="" />
									...
									<div role="tabpanel" class="tab-pane" id="img-four">
										<img src="<?=template_user3_path?>/img/single-product/mediam/4.jpg" alt="" />
								...
								<!-- Nav tabs -->
								<ul class="" >
									<li class="active"><a href="#img-one"  data-toggle="tab"><img src="<?=template_user3_path?>/img/single-product/mediam/3.jpg" alt="" /></a></li>
									<li><a href="#img-two"  data-toggle="tab"><img src="<?=template_user3_path?>/img/single-product/mediam/2.jpg" alt="" /></a></li>
									<li><a href="#img-three"  data-toggle="tab"><img src="<?=template_user3_path?>/img/single-product/mediam/3.jpg" alt="" /></a></li>
									<li><a href="#img-four"  data-toggle="tab"><img src="<?=template_user3_path?>/img/single-product/mediam/4.jpg" alt="" /></a></li>
								</ul>
							</div>
						</div>
											...
											<ul>
												<li>
													<div class="product-comments">
														<img src="<?=template_user3_path?>/img/author.jpg" alt="" />
