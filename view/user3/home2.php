  <!--[if lt IE 8]>
		...
		<section class="page-content">		
			<!-- SLIDER-AREA START -->
			<div class="slider-area style-2 margin-bottom-80">
				<div class="bend niceties preview-2">
					<div id="ensign-nivoslider" class="slides">	
						<img src="<?=template_user3_path?>/img/slider/slider-1/2.jpg" alt="" title="#slider-direction-1"  />
						<img src="<?=template_user3_path?>/img/slider/slider-1/1.jpg" alt="" title="#slider-direction-2"  />
						<img src="<?=template_user3_path?>/img/slider/slider-1/3.jpg" alt="" title="#slider-direction-3"  />
					</div>
					<!-- direction 1 -->
							...
							<div class="title-container s-tb-c title-compress">
								<div class="slider-1">
									<div class="wow fadeInUpBig" data-wow-duration="1.2s" data-wow-delay="0.5s">
										<h1 class="title1">Men fashion collection</h1>
									</div>
					...
					<div id="slider-direction-2" class="slider-direction">
						...
						<div class="slider-content t-lfl s-tb">
							<div class="title-container s-tb-c title-compress">
								<div class="slider-1">
									<div class="wow fadeInUpBig" data-wow-duration="1.2s" data-wow-delay="0.5s">
										<h1 class="title1">Women fashion collection</h1>
									</div>
									<div class="image wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0.7s">
										<span><img src="<?=template_user3_path?>/img/slider/slider-1/slider-border.png" alt="" /></span>
									</div>
			...
			<div class="banner-style-2-area fix">
				<div class="container">
					<div class="row">
							...
							<div class="banner-style-2">
								<div class="single-banner-style-2 banner-brief-1">
									<div class="left-banner-img">
										<img class="" src="<?=template_user3_path?>/img/banner/3.png" alt="" />
									</div>
									<div class="left-banner-brief">
										<h3>new fashion collection</h3>
										<h4>passages dress</h4>
										<h4>$50.00</h4>
								...
								<div class="single-banner-style-2 banner-brief-2">
									...
									<div class="right-banner-img">
										<img class="" src="<?=template_user3_path?>/img/banner/4.png" alt="" />
									</div>
								</div>
							</div>
						</div>
			...
			<div class="new-collection-area fix style-2 margin-bottom-80">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<div class="section-title-2 bordr-rights">
								<h2 class="border-left-rights">New Collection</h2>
							</div>
						</div>
					</div>
				</div>
				<div class="new-collection active-new-collection-2">
					<!-- Single-product start -->
					<div class="single-product new-colect">
						<div class="product-photo">
							<a href="#">
								<img class="primary-photo" src="<?=template_user3_path?>/img/new-collection/new-2/1.jpg" alt="" />
								<img class="secondary-photo" src="<?=template_user3_path?>/img/new-collection/new-2/5.jpg" alt="" />
							</a>
					...
					<div class="single-product new-colect">
						<div class="product-photo">
							<a href="#">
								<img class="primary-photo" src="<?=template_user3_path?>/img/new-collection/new-2/2.jpg" alt="" />
								<img class="secondary-photo" src="<?=template_user3_path?>/img/new-collection/new-2/4.jpg" alt="" />
							</a>
							<div class="pro-action">
								<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
								<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
					...
					<div class="single-product new-colect">
						<div class="product-photo">
							<a href="#">
								<img class="primary-photo" src="<?=template_user3_path?>/img/new-collection/new-2/3.jpg" alt="" />
								<img class="secondary-photo" src="<?=template_user3_path?>/img/new-collection/new-2/1.jpg" alt="" />
							</a>
							<div class="pro-action">
								<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
								<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
					...
					<div class="single-product new-colect">
						<div class="product-photo">
							<a href="#">
								<img class="primary-photo" src="<?=template_user3_path?>/img/new-collection/new-2/4.jpg" alt="" />
								<img class="secondary-photo" src="<?=template_user3_path?>/img/new-collection/new-2/2.jpg" alt="" />
							</a>
							<div class="pro-action">
								<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
								<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
					...
					<div class="single-product new-colect">
						<div class="product-photo">
							<a href="#">
								<img class="primary-photo" src="<?=template_user3_path?>/img/new-collection/new-2/5.jpg" alt="" />
								<img class="secondary-photo" src="<?=template_user3_path?>/img/new-collection/new-2/3.jpg" alt="" />
							</a>
							<div class="pro-action">
								<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
								<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
			...
			<div class="promotional-banner-area fix style-2 margin-bottom-80">
				<div class="promotional-banner">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<!-- Single-promo start -->
								<div class="single-promo-banner promo-banner-3">
								...
								<!-- Single-promo End -->
								<!-- Single-promo start -->
								<div class="single-promo-banner promo-banner-4">
									 <a class="shop-now" href="#">pre order</a>
									<div class="promo-banner-brief">
										...
										<div class="active-best-sell navigation-top-right">
											<div class="col-md-12">
												...
												<div class="single-product">
													<div class="product-photo">
														<a href="#">
															<img class="primary-photo" src="<?=template_user3_path?>/img/best-sell/1.jpg" alt="" />
															<img class="secondary-photo" src="<?=template_user3_path?>/img/best-sell/6.jpg" alt="" />
														</a>
														<div class="pro-action">
															<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
															<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
												...
												<div class="single-product">
													<div class="product-photo">
														<a href="#">
															<img class="primary-photo" src="<?=template_user3_path?>/img/best-sell/4.jpg" alt="" />
															<img class="secondary-photo" src="<?=template_user3_path?>/img/best-sell/1.jpg" alt="" />
														</a>
														<div class="pro-action">
															<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
															<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
											...
											<div class="col-md-12">
												...
												<div class="single-product">
													<div class="product-photo">
														<a href="#">
															<img class="primary-photo" src="<?=template_user3_path?>/img/best-sell/2.jpg" alt="" />
															<img class="secondary-photo" src="<?=template_user3_path?>/img/best-sell/4.jpg" alt="" />
														</a>
														<div class="pro-action">
															<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
															<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
												...
												<div class="single-product">
													<div class="product-photo">
														<a href="#">
															<img class="primary-photo" src="<?=template_user3_path?>/img/best-sell/5.jpg" alt="" />
															<img class="secondary-photo" src="<?=template_user3_path?>/img/best-sell/1.jpg" alt="" />
														</a>
														<div class="pro-action">
															<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
											...
											<div class="col-md-12">
												...
												<div class="single-product">
													<div class="product-photo">
														<a href="#">
															<img class="primary-photo" src="<?=template_user3_path?>/img/best-sell/4.jpg" alt="" />
															<img class="secondary-photo" src="<?=template_user3_path?>/img/best-sell/5.jpg" alt="" />
														</a>
														<div class="pro-action">
															<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
															<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
											...
											<div class="col-md-12">
												...
												<div class="single-product">
													<div class="product-photo">
														<a href="#">
															<img class="primary-photo" src="<?=template_user3_path?>/img/best-sell/3.jpg" alt="" />
															<img class="secondary-photo" src="<?=template_user3_path?>/img/best-sell/5.jpg" alt="" />
														</a>
														<div class="pro-action">
															<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
												...
												<div class="single-product">
													<div class="product-photo">
														<a href="#">
															<img class="primary-photo" src="<?=template_user3_path?>/img/best-sell/6.jpg" alt="" />
															<img class="secondary-photo" src="<?=template_user3_path?>/img/best-sell/2.jpg" alt="" />
														</a>
														<div class="pro-action">
															<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
															<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
			...
			<div class="best-sell-2-area  margin-bottom-80">
				...
				<div class="active-best-sell-2 navigation-top-right">
					...
					<div class="single-best-sell-2">
						<img src="<?=template_user3_path?>/img/best-sell-2/1.png" alt="" />
					...
					<!-- Single-best-sell-2 Start -->
					<div class="single-best-sell-2">
						<img src="<?=template_user3_path?>/img/best-sell-2/2.png" alt="" />
						<div class="best-sell-2-brief">
					...
					<!-- Single-best-sell-2 Start -->
					<div class="single-best-sell-2">
						<img src="<?=template_user3_path?>/img/best-sell-2/3.png" alt="" />
						<div class="best-sell-2-brief">
							<h3><a href="#">Bags</a></h3>
							<p>Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
							<a href="#" class="shop-now">Shop Now</a>
					...
					<!-- Single-best-sell-2 Start -->
					<div class="single-best-sell-2">
						<img src="<?=template_user3_path?>/img/best-sell-2/4.png" alt="" />
						<div class="best-sell-2-brief">
										...
										<div class="single-testimonial">
											<div class="col-md-4 col-sm-4 col-xs-12">
												<div class="client-photo">
													<img src="<?=template_user3_path?>/img/testimonial/1.png" alt="" />
												</div>
											</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="single-blog">
								<div class="blog-photo">
									<a href="#"><img src="<?=template_user3_path?>/img/blog/1.jpg" alt="" /></a>
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="single-blog">
								<div class="blog-photo">
									<a href="#"><img src="<?=template_user3_path?>/img/blog/2.jpg" alt="" /></a>
									<div class="blog-post-date">
										<span>13th</span>
										<span>Feb</span>
									</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="single-blog">
								<div class="blog-photo">
									<a href="#"><img src="<?=template_user3_path?>/img/blog/3.jpg" alt="" /></a>
									<div class="blog-post-date">
										<span>25th</span>
										<span>Feb</span>
									</div>
