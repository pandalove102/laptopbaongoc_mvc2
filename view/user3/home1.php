<?php 
// if(isset($_SESSION['login_user']) && isset($_SESSION['user_dangnhap']) && 
// isset($_SESSION['pass_dangnhap']) && isset($_SESSION['ten_quantri']) && 
// isset($_SESSION['awatar_nguoidung']))
// {
	// echo  $_SESSION['login_user'];
	// echo $_SESSION['user_dangnhap'];
	// echo $_SESSION['pass_dangnhap'];
	// echo $_SESSION['ten_quantri'];
	// echo  $_SESSION['awatar_nguoidung'];
// }
