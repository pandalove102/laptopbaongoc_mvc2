    ...
    <section class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="page-banner-menu">
								<h2 class="page-banner-title">About</h2>
								<ul>
						...
						<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12">
							<div class="about-us">
								<div class="about-us-photo">
									<img src="<?=template_user3_path?>/img/banner/about.jpg" alt="" />
								</div>
			...
			<!-- ABOUT-AREA END -->
			<!-- ABOUT-BANNER START -->
			<div class="about-banner-area margin-bottom-80">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="single-best-sell-2">
								<img src="<?=template_user3_path?>/img/team/1.jpg" alt="" />
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="single-best-sell-2">
								<img src="<?=template_user3_path?>/img/team/2.jpg" alt="" />
								<div class="best-sell-2-brief">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="single-best-sell-2">
								<img src="<?=template_user3_path?>/img/team/3.jpg" alt="" />
								<div class="best-sell-2-brief">
