...
<form method="POST" action="?controller=danhmucsanpham&act=add_danhmuc"   enctype="multipart/form-data" id="fupdate">
<div class="content">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="form-group label-floating">
                            ...
                            <input type="text" name="id_danhmucsanpham" value="" class="form-control">
                        </div>
                        <div class="form-group label-floating">
                            <label class="control-label">Tên Danh Mục</label>
                            <input type="text" name="ten_danhmucsanpham" value="" class="form-control">
                        </div>
                        <div class="form-group label-floating">
