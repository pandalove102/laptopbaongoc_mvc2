...
<form method="POST" action="?controller=dungluong&act=add_dungluong"   enctype="multipart/form-data" id="fupdate">
<div class="content">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="form-group label-floating">
                            ...
                            <input type="text" name="id_dungluong" value="" class="form-control">
                        </div>
                        <div class="form-group label-floating">
                            <label class="control-label">Dung lượng</label>
                            <input type="text" name="dungluong" value="" class="form-control">
                        </div>
