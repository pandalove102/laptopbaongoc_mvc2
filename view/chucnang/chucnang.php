    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <a href="?controller=chucnang&act=add_chucnang_view">
                    <div class="card-header card-header-icon" data-background-color="purple">
                        <i class="material-icons">library_books</i>
                </div></a>
                <div class="card-content">
                    <h4 class="card-title">Chức Năng</h4>
                    <div class="toolbar">
                    ...
                    <div class="material-datatables">
                      ...
                      <div class="row">
                          ...
                          <thead>
                              ...
                              <th class="text-center sorting" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 143px;font-family: initial;" aria-label="Position: activate to sort column ascending">Chức Năng</th>
                              <th class="text-center sorting" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 143px;font-family: initial;" aria-label="Position: activate to sort column ascending">Link</th>
                          ...
                          <?php
                                  foreach($data['danhsachchucnang'] as $item)
                                  {
                          ?>
                          <tr role="row" class="odd">
                                  ...
                                  <td class="text-center sorting"><?=$item->link?></td>
                                  ...
                                  <td class="td-actions text-center">
                                      <a href="?controller=chucnang&act=chitiet_chucnang&id=<?=$item->id_chucnang;?>" class="btn btn-success btn-simple" >
                                          <i class="material-icons">edit</i>
                                      <div class="ripple-container"></div></a>
                                      <a onclick="return confirm('Bạn có chắc chắn muốn xóa không ?')" href="?controller=chucnang&act=dell_chucnang&id=<?=$item->id_chucnang;?>" class="btn btn-danger btn-simple">
