...
<form method="POST" action="?controller=logs&act=update_logs&id=11<?=@$data['chitietlogs']->id_logs?>"   enctype="multipart/form-data" id="fupdate">
<div class="content">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="form-group label-floating">
                            ...
                            <input type="text" name="id_logs" value="<?=@$data['chitietlogs']->id_logs?>" class="form-control">
                        </div>
                        <div class="form-group label-floating">
                            <label class="control-label">Nội Dung</label>
                            <input type="text" name="noidung" value="<?=@$data['chitietlogs']->noidung?>" class="form-control">
                        </div>
                        <div class="form-group date">
                            <label class="control-label">Ngày Tạo</label>
                            <input type="text" id="datetimepicker1" name="ngaytao"   class=" form-control datetimepicker" value="<?php echo @$data['chitietlogs']->ngaytao ?>"      />
                          
                        </div>

                        <div class="form-group ">
                            <label class="control-label">Ngày Cập Nhật Cuối</label>
                            <input type="text" id="datetimepicker2" name="ngaycapnhatcuoi" class="form-control datetimepicker" value="<?php echo@$data['chitietlogs']->ngaycapnhatcuoi ?>"  />
                        ...
                        <div class="form-group label-floating">
                                ...
                                <select  class="selectpicker" name="id_trangthai"  data-style="btn btn-primary btn-round" style="border-radius: 4px" title="Single Select" data-size="7" tabindex="-98">
                                        ...
                                        <?php
                                            ...
                                            {
                                        ?>
                                        <option   value="<?php echo @$v->id_trangthai ?>" <?php if(@$v->id_trangthai==$data['chitietlogs']->trangthai) echo "selected" ?>>
