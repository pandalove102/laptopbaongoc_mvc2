...
<form method="POST" action="?controller=logs&act=add_logs"   enctype="multipart/form-data" id="fupdate">
<div class="content">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="form-group label-floating">
                            ...
                            <input type="text" name="id_logs" value="" class="form-control">
                        </div>
                        <div class="form-group label-floating">
                ...
                <div class="card">
                    <div class="card-content text-center">
                            <div class="form-group form-button">
                                <a href="?controller=logs&act=danhsach_logs" class="btn btn-fill btn-rose" style="color:white">Back</a>
