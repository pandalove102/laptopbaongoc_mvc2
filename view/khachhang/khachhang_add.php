...
<form method="POST" action="?controller=khachhang&act=add_khachhang"   enctype="multipart/form-data" id="fupdate">
<div class="content">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="form-group label-floating">
                            ...
                            <input type="text" name="id_khachhang" value="" class="form-control">
                        </div>
                        <div class="form-group label-floating">
                        ...
                        <div class="form-group label-floating">
                            ...
                            <input type="text" name="diachigiaohang" value="" class="form-control">
                        </div> 
